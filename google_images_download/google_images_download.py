...
class googleimagesdownload:
    ...
    def download_extended_page(self, url, chromedriver, proxy=None):
    ...
    def download_executor(self, arguments):
        ...
        if arguments['output_directory']:
            ...
            main_directory = os.path.join(Path.home(), 'Downloads')

        # Initialize proxy
        if arguments['proxy']:
            proxies = {}
            proxy = arguments['proxy'].strip().lower()
                    ...
                    if arguments['related_images']:
                        ...
                        for key, value in tabs.items():
                            ...
                            if limit < LIMIT:
                                ...
                                new_raw_html = self.download_extended_page(value,
                                                                           arguments['chromedriver'],
                                                                           arguments.get('proxy'))
